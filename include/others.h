...
#define CHECK_SERVER_STATUS_T 5 * 60 * 1000 // checks if the influx db server is up or not every 5 mins if it was down
...
#define V_START_PORTAL_BIT_SET 18 // validate the start portal thing to the setup function
